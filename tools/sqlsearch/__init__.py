...
def sql_train(question,ddl,documentation,sql,app_id):
    return lanzhou.train(question=question,ddl=ddl,documentation=documentation,sql=sql,app_id=app_id)
